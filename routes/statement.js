...
const {
  getAllStatementsByUserId,
  getStatementsToPrint,
} = require("../controllers/statementController.js");
...
route.get("/admin/:id", getStatementsToPrint);
route.get("/:id", getAllStatementsByUserId);
